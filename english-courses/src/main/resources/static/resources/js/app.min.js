...
(APP = new (APP = function () {
    ...
    $(".metismenu").metisMenu(), $('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), $(".scroller").each(function () {
        ...
        var e = $(this).val();
        "default" != e ? $("#theme-style").length ? $("#theme-style").attr("href", "/resources/css/themes/" + e + ".css") : $("head").append("<link href='/resources/css/themes/" + e + ".css' rel='stylesheet' id='theme-style' >") : $("#theme-style").remove()
